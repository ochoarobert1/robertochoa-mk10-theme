...
add_action( 'after_setup_theme', 'robertochoa_woocommerce_support' );
function robertochoa_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'robertochoa_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'robertochoa_woocommerce_custom_wrapper_end', 10);

function robertochoa_woocommerce_custom_wrapper_start() {
    echo '<section id="main" class="container-fluid"><div class="row"><div class="woocustom-main-container col-12">';
}

function robertochoa_woocommerce_custom_wrapper_end() {
