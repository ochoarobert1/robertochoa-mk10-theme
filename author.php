            ...
            <div class="container p-0">
                <div class="row">
                    <div class="title-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h1><?php _e('Archivo de', 'robertochoa'); ?> <?php echo get_the_author(); ?></h1>
                        <?php if ( get_the_author_meta('description')) : ?>
                        <?php echo get_avatar(get_the_author_meta('user_email')); ?>
                        <h2><?php _e('Acerca de', 'robertochoa'); ?> <?php echo get_the_author() ; ?></h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12">
                                        <header>
                                            ...
                                            <span class="author" itemprop="author" itemscope itemptype="http://schema.org/Person"><?php _e('Publicado por:', 'robertochoa'); ?> <?php the_author_posts_link(); ?></span>
                                        </header>
                                        <p><?php the_excerpt(); ?></p>
                                        <a href="<?php the_permalink(); ?>" title="<?php _e('Leer Más', 'robertochoa'); ?>" class="btn btn-md btn-dark"><?php _e('Leer Más', 'robertochoa'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </article>
